        ...
        body: BlocBuilder<ServicebooknowBloc, ServicebooknowState>(
          builder: (context, state) {
            return state.isLoading
                ...
                : Form(
                    key: _booknowformkey,
                    child: BlocListener<PaymentcubitCubit, PaymentcubitState>(
                        ...
                        payment.when(
                          ...
                          paymentFailedState: () {
                            Alert(
                              ...
                              desc: "Some thing went Wrong Please try again",
                              buttons: [
                                DialogButton(
                                  onPressed: () async {
                                    Navigator.pop(context);
                                ...
                                Positioned(
                                  child: IconButton(
                                    onPressed: () async {
                                      ...
                                      // ignore: use_build_context_synchronously
                                      context.read<CalenderBloc>().add(
                                          DaySelectingEvent(DateTime.now()));
                                      // ignore: use_build_context_synchronously
                            ...
                            OutlinedButton(
                              ...
                              onPressed: () {
                                if (_booknowformkey.currentState!.validate() &&
                                  ...
                                  context
                                      .read<PaymentcubitCubit>()
                                      .submitpayent(
                                          widget.servicetobook.service.name,
                                          1,
                                          state.address!.address,
                                          'upi',
                                          widget.servicetobook.service.price);
